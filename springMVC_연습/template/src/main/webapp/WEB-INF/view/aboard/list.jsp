...
<div class="btn_board">
	<button type="button" class="btn btn-dark btn-sm" onclick="javascript:location.href='<%=cp%>/aboard/list'">새로고침</button>
	<button type="button" class="btn btn-dark btn-sm" onclick="javascript:location.href='<%=cp%>/aboard/created'">글등록</button>
</div>
